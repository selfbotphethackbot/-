            ...
            if mid in op.param3:
                ...
                if wait["autoJoin"] == True:
                    if wait["autoCancel"]["on"] == True:
                        ...
                        cl.sendText(op.param1, "[SELFBOT PHET HACK BOT]\n\nhttp://line.me/ti/p/~Phet_testbot")
                    else:
                        cl.acceptGroupInvitation(op.param1)
...
#==================================================
            ...
            elif msg.text in ["มาหำ","#Kicker","#kicker","Kicker","kicker","เข้ามา"]:
...
#==================================================
                ...
                if msg.from_ in admin:
                 wait["winvite"] = True
                 cl.sendText(msg.to,"โปรดส่งข้อมูลเพื่อนที่จะเชิญ")
                ...
                if msg.from_ in admin:
                 wait["ainvite"] = True
                 ki1.sendText(msg.to,"โปรดส่งข้อมูลเพื่อนที่จะเชิญ")
            elif msg.text in ["Bot2 invite contact","2เชิญ"]:
                if msg.from_ in admin:
                 wait["binvite"] = True
                 ki2.sendText(msg.to,"โปรดส่งข้อมูลเพื่อนที่จะเชิญ")
...
#เทส
                ...
                if wait["protectionOn"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already on\n\n"+ datetime.today().strftime('%H:%M:%S'))
            elif msg.text in ["Qr:off","Qr off","qr off"]:
                if wait["qr"] == False:
                    if wait["lang"] == "JP":
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already off\n\n"+ datetime.today().strftime('%H:%M:%S'))
            elif msg.text in ["Qr:on","Qr on","qr on"]:
                if wait["qr"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Already on\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
            ...
            elif "nameginfo:off" in msg.text:
                if msg.to in wait['pname']:
                    cl.sendText(msg.to,"Done..")
            ...
            elif msg.text in ["เปิดข้อมูลคอนเเท็กออน"]:
            ...
            elif msg.text in ["Auto join on","Join on","Join:on","Auto join:on","join on"]:
                if wait["autoJoin"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Sudah on Bosqu")
                    else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Ok Bosqu")
            elif msg.text in ["Join off","Auto join off","Auto join:off","Join:off","join off"]:
            ...
            elif msg.text in ["Auto like:on","Like on","like on"]:
                if wait["likeOn"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Done。")
                else:
                    ...
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Already。")
            elif msg.text in ["Like off","Auto like:off","like off"]:
...
#-----------------------------------------------
            ...
            elif msg.text in ["Add:on","Auto add on","Auto add:on","Add on","add on"]:
                if wait["autoAdd"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Sudah on Bosqu")
                    else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Sudah on Bosqu")
            elif msg.text in ["Add:off","Auto add off","Auto add:off","Add off","add off"]:
...
#========================================
#========================================
            elif "me set:" in msg.text:
                wait["message"] = msg.text.replace("me set:","")
                ...
                if wait["lang"] == "JP":
                    ...
                    cl.sendText(msg.to,"done。\n\n"+ datetime.today().strftime('%H:%M:%S'))
            elif msg.text in ["Message","Com","com"]:
                if wait["lang"] == "JP":
...
#-----------------------------------------------
            ...
            elif msg.text in ["Notifed on","เปิดแจ้งเตือน","M on","m on"]:
              if msg.from_ in admin:
                if wait["Notifed"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Done\n\nเปิดเเจ้งเเตือนของคุณเเล้ว")
            elif msg.text in ["Notifed off","ปิดแจ้งเตือน","M off","m off"]:
              if msg.from_ in admin:
            ...
            elif msg.text in ["Notifedbot on","เปิดเเจ้งเตือนบอท","Mbot on","mbot on"]:
              if msg.from_ in admin:
                if wait["Notifedbot"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Done\n\nเปิดเเจ้งเเตือนบอทเเล้ว")
            elif msg.text in ["Notifedbot off","ปิดแจ้งเตือนบอท","Mbot off","mbot off"]:
              if msg.from_ in admin:
...
#-----------------------------------------------------------
                ...
                cl.sendText(msg.to,"เพิ่มบัญชีดำ..โปรดส่งข้อมูล")
            
            elif msg.text in ["Unban"."ขาว"]:
                wait["dblacklist"] = True
                cl.sendText(msg.to,"ล้างบัญชีดำ..โปรดส่งข้อมูล")
...
#==============================================================================#
                ...
                bahasa_awal = 'th'
                bahasa_tujuan = 'en'
                kata = msg.text.replace("แปลอังกฤษ:","")
                url = 'https://translate.google.com/m?sl=%s&tl=%s&ie=UTF-8&prev=_m&q=%s' % (bahasa_awal, bahasa_tujuan, kata.replace(" ", "+"))
                agent = {'User-Agent':'Mozilla/5.0'}
                cari_hasil = 'class="t0">'
                request = urllib2.Request(url, headers=agent)
