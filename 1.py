...
cl = LINETCR.LINE()
cl.login(token="EnEouZzYgiBdUsSOoOAa.apGNZMzba418M2CeQxD9/G.OIF0t8VWxqhw7rcKKFjfCE33czcT8TXeFuYe2OYlu4g=")
cl.loginResult()

ki1 = LINETCR.LINE() #ได้
ki1.login(token="EnE5QHNMIonjmjOcHCDc.CO+7oq+Id0B3tC7KLHEC+a.lIee3Uy/ldHkBxhbSlCracNRJJKwMM5v2s5YCYOy6tc=")
ki1.loginResult()

ki2 = LINETCR.LINE() #ได้
ki2.login(token="EnQiJRw1Om2KQPP4bYm8.CgIyS0c7xZdRr51nJTAJYa.orACS2Oo09Fqv8paNJoqUjobtrTANYqYxIspzs84CDQ=")
ki2.loginResult()

ki3 = LINETCR.LINE() #ได้
ki3.login(token="EnNE0sa3nXagpfa6Pmvf.+tkahgVAVIBOp95o+hq8pW.3saI27JgEsmgJ5T2MYQwM4sJsWLvkdYVXydUeKlZrzU=")
ki3.loginResult()

ki4 = LINETCR.LINE() #ได้
ki4.login(token="EnE1ndFGYiKPGDkBsiFc.+s0gZ95G+UbOwn6HBwdARa.FqOV7NyW3NcbU3VZXWikw3ecA25jIfEEFP0qPI4DrHI=")
ki4.loginResult()

ki5 = LINETCR.LINE() #ได้
ki5.login(token="EnjNqGSCT6xJKvvYhU07.j7KnDswLtwUeGfi7ei2pHW.Z0BEBHja1RzqNQbMbTBkAGoaVdTFPYbFMROyidM3XcM=")
ki5.loginResult()

ki6 = LINETCR.LINE() #ได้
ki6.login(token="EnOBzGGDNLC7zfFRMhR2.WNxXkB0Ef2HoYT8GANUASG.V3h6Ea4MGghsFDcntSDs6gbtKVI+Ldd151Oof2d28Gs=")
ki6.loginResult()

ki7 = LINETCR.LINE() #ได้
ki7.login(token="EnKn9yERU2v4x6vymcid.gli6pSIch87TKgmSyoYOxq.PyEmlzb0XCmvMOsbZioEz4ayzizKOqHzpmiaOiwiE7U=")
ki7.loginResult()

ki8 = LINETCR.LINE() #ได้
ki8.login(token="EnoKXFBEXGAriWqhfqF0.6bJeLu3wPsayzUqPGUc1qa.Etqwzd14drHZoZN5WC0dDTzeSmuz+xbGMV6HWpyi73k=")
ki8.loginResult()

ki9 = LINETCR.LINE() #ได้
ki9.login(token="EnMkXEcDGLJJd9UF9Lcb.cPhc+G+OXVF9Z1ip7AJJEW.sZogGhFgdPMVWMQhHXtq5ZMTj4VJe3J+HT5x4QUmus4=")
ki9.loginResult()

ki10 = LINETCR.LINE() #ได้
ki10.login(token="EnjdaPj3E5xtS0lBnah5.BVlG22SNeX4egNRgN6XK1q.3zWx1OleOcUSw2ZCipB70zPyf3kqxeo69uq9mPlJ5Hw=")
ki10.loginResult()
       ...
       #-------------Fungsi Respon Start---------------------#
                ...
                cl.sendText(msg.to,X)
                    ...
                    with requests.session() as s:
                        ...
                        mp3  = r.url
                        cl.sendAudioWithUrl(msg.to, mp3)
            elif "#contactall" in msg.text:
                       nk0 = msg.text.replace("#contactall","")
                       nk1 = nk0.lstrip()
                       nk2 = nk1.replace("","")
                       nk3 = nk2.rstrip()
                       _name = nk3
        ...
        if op.type == 26:
            msg = op.message
            if msg.text.lower() in ["#phet test tastsegg all"]:
                group = cl.getGroup(msg.to)
                nama = [contact.mid for contact in group.members]
                nm1, nm2, nm3, nm4, nm5, jml = [], [], [], [], [], len(nama)
                if jml <= 100:
